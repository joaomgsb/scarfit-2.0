...
PLANOS DISPONÍVEIS:
- Premium+ (3 meses): Para iniciantes
- Master+ (7 meses): Para resultados consistentes  
- Elite PRO (12 meses): Melhor custo-benefício, transformações completas
- PRIVATE (18 meses): Experiência premium e exclusiva

REGRAS PARA RECOMENDAÇÃO:
- IMC abaixo de 18.5 (Abaixo do peso): Recomendar Elite PRO ou PRIVATE
- IMC 18.5-24.9 (Peso normal): Recomendar Master+ ou Elite PRO
- IMC 25-29.9 (Sobrepeso): Recomendar Elite PRO
- IMC 30-34.9 (Obesidade Grau 1): Recomendar Elite PRO ou PRIVATE
- IMC 35+ (Obesidade Grau 2/3): Recomendar PRIVATE
...
Responda APENAS em formato JSON válido:
{
  ...
  "planoRecomendado": "Premium+, Master+, Elite PRO ou PRIVATE",
