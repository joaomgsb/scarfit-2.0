...
const RoadmapPath = ({ inView }: { inView: boolean }) => (
  <div className="absolute top-0 left-0 w-full h-full z-0 pointer-events-none">
    <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 800 1400">
      <motion.path
    ...
    <section className="section-padding section-transition" ref={ref}>
      <div className="container-custom">
        ...
        >
          ...
          {/* Steps */}
          <div className="relative py-16"> {/* Container relativo para o SVG */}
              ...
              >
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                    ...
                    <h3 className="text-3xl font-semibold text-light mb-4">
                      {step.title}
                    </h3>
