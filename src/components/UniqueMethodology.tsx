...
const UniqueMethodology: React.FC = () => {
  ...
  return (
    <section id="unique-methodology" className="relative py-20 md:py-24 bg-gradient-to-br from-dark via-dark-lighter to-dark text-white overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-dark-lighter/90 to-dark/90 backdrop-blur-xl rounded-3xl p-8 border border-red-500/20 hover:border-red-500/40 transition-all duration-300 h-full shadow-2xl">
              ...
              <div className="space-y-4">
                {outrosProblemas.map((problema, index) => (
                  <div key={index} className="flex items-start gap-3 group/item hover:bg-red-500/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <p className="text-light-gray font-medium methodology-text group-hover/item:text-white transition-colors duration-300">{problema}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <motion.div variants={itemVariants} className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-dark-lighter/90 to-dark/90 backdrop-blur-xl rounded-3xl p-8 border border-primary/20 hover:border-primary/40 transition-all duration-300 h-full shadow-2xl">
              <div className="text-center mb-8">
              ...
              <div className="space-y-4">
                {methodologyFeatures.map((feature, index) => (
                  <div key={index} className="flex items-start gap-3 group/item hover:bg-primary/5 p-3 rounded-lg transition-all duration-300">
                    ...
                    <p className="text-light-gray font-medium methodology-text group-hover/item:text-white transition-colors duration-300">{feature}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        >
          <div className="bg-gradient-to-br from-dark-lighter/90 to-dark/90 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-primary/20 max-w-3xl mx-auto">
              <h4 className="text-2xl font-bold text-white mb-4">A Diferença Está nos Detalhes</h4>
