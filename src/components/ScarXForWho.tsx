...
const ScarXForWho: React.FC = () => {
  return (
    <section className="relative bg-dark py-20 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-yellow-400 transform rotate-12 translate-x-20 -translate-y-20 opacity-20"></div>
      <div className="absolute bottom-0 right-0 w-32 h-32 bg-yellow-400 transform rotate-45 translate-x-16 translate-y-16 opacity-30"></div>
        ...
        <div className="flex flex-col lg:flex-row -mx-4">
          ...
          <div className="w-full lg:w-1/2 px-4 relative flex flex-col justify-center order-2 lg:order-1">
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 leading-tight">
              ...
              <br />
              <span className="text-yellow-400 italic">PRA QUEM?</span>
            </h2>
          ...
          <div className="w-full lg:w-1/2 px-4 mt-8 lg:mt-0 order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="relative">
              ...
              <div className="absolute -top-8 -right-8 w-32 h-32 bg-yellow-400 transform rotate-12 opacity-80"></div>
